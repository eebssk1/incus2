...
Custom commands can be defined through aliases, use "incus alias" to control those.`))
	...
	// Help flags
	cli.AddBoolFlag(app.Flags(), &globalCmd.flagHelpAll, "all", i18n.G("Show less common commands"))
	cli.AddBoolFlag(help.Flags(), &globalCmd.flagHelpAll, "all", i18n.G("Show less common commands"))
